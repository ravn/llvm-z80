...
// (Codegen for the composed convention is checked in
// CodeGen/z80-smallc-callee.c.)

void sc_callee(int a, int b)
    __attribute__((z80_smallc)) __attribute__((z80_callee)); // ok: composes

void callee_sc(int a, int b)
    __attribute__((z80_callee)) __attribute__((z80_smallc)); // ok: composes, order-independent
