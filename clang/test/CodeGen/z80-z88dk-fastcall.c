...
//
// __attribute__((z88dk_fastcall)) selects the z88dk
...
__attribute__((z88dk_fastcall)) unsigned char id8(unsigned char x) { return x; }

// CHECK: define{{.*}}cc130 {{.*}}i16 @id16(i16
__attribute__((z88dk_fastcall)) unsigned short id16(unsigned short x) { return x; }

// CHECK: define{{.*}}cc130 i32 @id32(i32
__attribute__((z88dk_fastcall)) unsigned long id32(unsigned long x) { return x; }
