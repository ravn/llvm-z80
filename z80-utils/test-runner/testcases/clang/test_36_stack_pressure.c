...
/* The chain_a/b/c mutual recursion (bit 2) is detected by the call-graph analysis
 * in Z80NonReentrant, ensuring recursive functions keep ordinary stack frames
 * even under -ffreestanding / +static-frame. */
