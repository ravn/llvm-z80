...
; CHECK:      	add	hl,bc
; CHECK:      	ld	(L_main.frame+20),hl
; CHECK:      	ld	bc,(L_main.frame+18)
; CHECK:      	ld	l,c
; CHECK:      	ld	h,b
; CHECK:      	ld	e,(hl)
; CHECK:      	inc	hl
; CHECK:      	ld	d,(hl)
; CHECK:      	ex	de,hl
; CHECK:      	ld	de,(L_main.frame+20)
; CHECK:      	add	hl,de
; CHECK:      	ld	(L_main.frame+20),hl
; CHECK:      	ld	l,c
; CHECK:      	ld	h,b
; CHECK:      	ld	bc,(L_main.frame+22)
; CHECK:      	inc	hl
; CHECK:      	inc	hl
; CHECK:      	ld	e,(hl)
; CHECK:      	inc	hl
